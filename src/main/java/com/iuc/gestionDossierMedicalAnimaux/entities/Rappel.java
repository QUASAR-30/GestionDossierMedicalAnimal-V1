...
public class Rappel implements Serializable {
    ...
    public Rappel(Integer idRappel) {
        this.idRappel = idRappel;
    }

    public Rappel(Integer idRappel, String typeRappel, Date dateRappel) {
        this.idRappel = idRappel;
        this.typeRappel = typeRappel;
        this.dateRappel = dateRappel;
    }

    public Integer getIdRappel() {
        return idRappel;
    }

    public void setIdRappel(Integer idRappel) {
        this.idRappel = idRappel;
    }
